...
from shepherd_codex.metrics.failure_detector import FailureDetector
from shepherd_codex.planner.llm_planner import LLMPlanner
from shepherd_codex.planner.mock_llm import OracularPlanner
from shepherd_codex.shepherd_env.controllers import apply_enclosing_controller, apply_herding_controller, apply_seeking_controller
from shepherd_codex.shepherd_env.env import ShepherdEnv
from shepherd_codex.shepherd_env.sensors import feature_extractor
...
class ViewerWindow(QMainWindow):
    ...
    def __init__(self, cfg: dict[str, Any]) -> None:
        super().__init__()
        self.cfg = cfg
        self.env = ShepherdEnv("shepherd_codex/configs/default.yaml")
...
def main() -> None:
    with open("shepherd_codex/configs/default.yaml", "r", encoding="utf-8") as f:
